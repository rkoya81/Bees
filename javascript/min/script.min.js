...
myApp.controller('myCtrl',['$scope','$timeout', function($scope, $timeout) {
  ...
  $scope.availableBees.push(EasyRoom.availableBees('Queen'));

  for(var i = 0; i < 5; i++) {
    $scope.availableBees.push(EasyRoom.availableBees('Worker', i+1));
  }

  for(var i = 0; i < 8; i++) {
    $scope.availableBees.push(EasyRoom.availableBees('Drone', i+1));
  }
...
EasyRoom.availableBees = function(beeType, index) {
  var beeAttributes = {};
  switch(beeType) {
    case 'Queen': 
      beeAttributes = {
